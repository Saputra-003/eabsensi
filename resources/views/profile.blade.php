...
<div class="row">
    ...
    <div class="col-md-8 d-flex">
        ...
        <div class="card flex-fill">
            ...
            <div class="card-body">
                {{-- <p class="mb-4">Extend form controls by adding text or buttons before, after, or on both sides of
                    any text-based <code>&lt;input></code>. Use <code>.input-group</code> with an
                    <code>.input-group-prepend</code> to prepend or <code>.input-group-append</code> to append elements
                    to a single <code>.form-control</code>. Place one add-on or button on either side of an input. You
                    may also place one on both sides of an input. While multiple <code>&lt;input></code>s are supported
                        ...
                        <div class="col-lg-10">
                            <div class="input-group">
                                ...
                                <select class="form-control" name="gender">
                                    {{-- <option selected="{{ $profile->profile->gender == 'pria' ? 'selected' : '' }}"
                                        value="pria">Pria</option>
                                    <option selected="{{ $profile->profile->gender == 'wanita' ? 'selected' : '' }}"
                                        value="wanita">Wanita</option> --}}
                                    <option {{ $profile->profile->gender == 'pria' ? 'selected="selected"' : '' }}
                                        value="Pria">Pria</option>
                                    <option {{ $profile->profile->gender == 'wanita' ? 'selected="selected"' : '' }}
                                        value="Wanita">Wanita</option>
                                </select>
                            </div>
                        </div>
